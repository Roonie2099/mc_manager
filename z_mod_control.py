...
mods_storage_path = Path(__file__).parent / "mods_storage"
json_path = Path(__file__).parent / "z_mod_instance_control.json"
...
def menu():
    refresh()
    os.system("cls")
    print("Minecraft Mod Manager (beta)  -by Roonie-")
    print()
    print("Mod using:",len(mod_in_use))
    print("Instace using:")
    print()
    print("1. Add new mod to use")
